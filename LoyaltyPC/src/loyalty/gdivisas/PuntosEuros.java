		 ...
		 botonModificar.addActionListener(new ActionListener(){
				public void actionPerformed (ActionEvent e){	
					...
					if(eurosDescuentos.compareTo("")==0 || puntos.compareTo("")==0){
						int n = JOptionPane.showConfirmDialog (panelPuntosEuros,"Error, campos de datos vacíos.","Datos nulos",JOptionPane.CLOSED_OPTION);
					}else{
						...
						if(n==0){
							...
							if(exito){
								int j = JOptionPane.showConfirmDialog (panelPuntosEuros,"Divisa modificada con éxito.","Divisa modificada",JOptionPane.CLOSED_OPTION);
								panelPuntosEuros.setVisible(false);
								panelDivisas.setVisible(true);
							}else{
