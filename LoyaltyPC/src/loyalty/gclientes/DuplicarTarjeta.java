...
public class DuplicarTarjeta {
	...
	JLabel titulo = new JLabel("DUPLICADO DE TARJETA");
	
	JLabel lb_idCliente=new JLabel("·Id. Cliente:");
	JLabel lb_uidTag=new JLabel("·UID Tarjeta:");
	...
	public DuplicarTarjeta(String idCliente,JFrame frameConsulta,JPanel panelConsulta,
